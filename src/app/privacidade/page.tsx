      ...
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8 text-blue-700">
        ...
        <div className="flex flex-col items-start  justify-center">
          ...
          <p className="mt-4 text-justify text-sm">
            ...
            (“Serviços”) ou que de outra forma tenha nos concedido dados
          ...
          <p className="mt-4 text-justify text-sm">
            ...
            Caso seja um funcionário, colaborador ou fornecedor, cliente de
            produto licenciado ou se estiver participando de algum projeto ou
            atividade específica com o Abrir MEI Online, você deve buscar o
            respectivo aviso de privacidade emitido pelo Abrir MEI Online, ou o
            responsável por sua contratação na empresa, para que lhe forneça os
            termos aplicáveis e o informe a respeito de seus direitos sobre os
            seus dados.
          </p>
        </div>
        ...
        <div className="flex flex-col items-start justify-center mt-8">
          ...
          <p className="mt-4 text-justify text-sm">
            ...
            refletir dados pessoais que podem identificá-lo, bem como dados
            anonimizados.
          </p>
          ...
          <p className="mt-4 text-justify text-sm">
            ...
            Quando você interage com algum material construído pelo Abrir MEI
            Online, como um questionário, você estará nos concedendo acesso à
            determinados dados sobre você. Você pode nos enviar dados para fins
            limitados, responder a um questionário; participar de um estudo ou
            pesquisa; entrar em concursos ou sorteios; ou inscrever-se para
          ...
          <p className="mt-4 text-justify text-sm">
            ...
            próprio nos fornecendo seus dados pessoais. Por exemplo, ao nos
            enviar uma carta convencional, você informará seus dados de
            remetente, além do conteúdo da carta propriamente dita. Em mensagens
            eletrônicas do tipo e-mail você estará nos remetendo igualmente os
            metadados típicos desta forma de comunicação.
          </p>
          ...
          <p className="mt-4 text-justify text-sm">
            ...
            que seu filho(a) ou pessoa sob sua responsabilidade legal forneceu
            dados pessoais ao Abrir MEI Online sem o seu consentimento, você
            pode nos consultar sob a existência e requerer a deleção dessas
            informações entrando em contato conosco pelo e-mail:
          ...
          <p className="mt-4 text-justify text-sm">
            ...
            formulários ou requeridas para que possamos estabelecer qualquer
            tipo de contato mediado pelos Serviços não requerem necessariamente
            dados pessoais referentes à origem racial ou étnica, convicção
            religiosa, opinião política, filiação à sindicato ou à organização
            de caráter religioso, filosófico ou político, referentes à saúde ou
            à vida sexual, dados genéticos ou biométricos relativos à pessoa
            natural. Contudo, nas situações em que você nos submete
            voluntariamente dados pessoais sensíveis, por exemplo ao preencher
            um formulário ou nos enviar uma mensagem pelos canais de atendimento
            você concorda que podemos processar seus dados pessoais sensíveis.
          </p>
          ...
          <p className="mt-4 text-justify text-sm">
            ...
            dados incluem seu endereço IP, informações técnicas sobre seu
            dispositivo (tipo de navegador, sistema operacional, informações
            básicas do dispositivo, data e horário da sua solicitação,
            geolocalização), a página da web que você visitou ou a consulta de
            pesquisa que você inseriu antes de chegar até nós e suas atividades.
            Podemos rastrear suas atividades usando cookies e tecnologias
            semelhantes.
          </p>
        </div>
        {/* Uso dos dados */}
        <div className="flex flex-col items-start justify-center mt-8">
          ...
          <p className="mt-4 text-justify text-sm">
            ...
            agregados, em vez de dados específicos do usuário. Podemos, no
            entanto, precisar analisar um caso específico para resolver um
            problema específico como, por exemplo, um bug que afeta apenas
            algumas situações.
          </p>
        ...
        <div className="flex flex-col items-start justify-center mt-8">
          ...
          <p className="mt-4 text-justify text-sm">
            ...
            suas instruções e obrigações contratuais. Isso pode incluir
            processadores de pagamento, redes de entrega de conteúdo (CDNs),
            serviços de hospedagem baseados em nuvem, serviços de monitoramento,
            provedores de serviços de e-mail, garantia de qualidade e
            fornecedores de teste, fornecedores de prevenção de fraude e abuso,
            fornecedores de gerenciamento de relacionamento com o cliente (CRM)
          ...
          <div className="mt-4 text-justify text-sm">
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                ...
                exceto nas hipóteses previstas
              </li>
            </ul>
          </div>
        ...
        <div className="flex flex-col items-start justify-center mt-8">
          ...
          <p className="mt-4 text-justify text-sm">
            ...
            Essas medidas são elaboradas para oferecer um nível de segurança
          ...
          <p className="mt-4 text-justify text-sm">
            ...
            seus dados seguros evitando comportamentos imprudentes e temerários.
          </p>
        </div>
        ...
        <div className="flex flex-col items-start justify-center mt-8">
          ...
          <p className="mt-4 text-justify text-sm">
            ...
            você clicar em um link de uma de nossas redes sociais, poderá ser
            levado ao ambiente do provedor de serviços de referida rede social.
            Uma vez em um site de terceiros, seus dados podem ser coletados por
            terceiros. Nós encorajamos você a ler as políticas de privacidade de
